...
If the operation was successful, the client will output the xref:cas-concurrency.adoc#concept_iq4_bts_zs[CAS] of the document.
...
The metadata consists of the document's ID, the xref:cas-concurrency.adoc#concept_iq4_bts_zs[CAS], xref:transcoders.adoc#concept_bdb_smb_bt[flags], and the size of the document in bytes.
