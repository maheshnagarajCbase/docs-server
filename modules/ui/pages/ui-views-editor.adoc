...
When viewing [.uicontrol]*Development Views*, you can perform the following actions:
...
When viewing [.uicontrol]*Production Views* you can perform the following operations on each design document:
