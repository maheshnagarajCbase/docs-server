...
* xref:2.1@java-sdk::java-intro.adoc#concept_l11_ppm_pp[Java SDK 2.2] The Couchbase Java SDK provides synchronous and asynchronous (reactive) interfaces that allow your applications to interact efficiently with a Couchbase Server cluster.
* xref:2.1@dotnet-sdk::dotnet-intro.adoc#concept_m1n_rqm_pp[.NET SDK 2.2] The .NET Couchbase SDK provides a way to store and retrieve your objects to and from a Couchbase cluster.
