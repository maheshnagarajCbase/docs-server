...
If you click on "[.ui]*Type Mappings*," you will only see one type listed, which is "[.out]``default``." image:fts-create-index-2.png[,300]
...
These can be found under [.ui]*Indexes* > [.ui]*Full Text* > *New* or btn:[Edit Full Text Index] buttons.
