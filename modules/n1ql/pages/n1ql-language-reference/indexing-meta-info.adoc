...
+
_Indexable from Couchbase Server 5.0_ For details, see xref:2.5@java-sdk::common/core-operations.adoc#devguide_kvcore_generic[Core Operations].

.flags:::
Value set by the SDKs for non-JSON documents.
+
For details, see xref:2.5@java-sdk::common/nonjson.adoc#devguide_nonjson[Non-JSON].
