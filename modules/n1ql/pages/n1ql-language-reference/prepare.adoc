...
For information on how to use prepared statements with various SDKs, refer to xref:2.4@nodejs-sdk:common:n1ql-query.adoc#prepare-stmts[Querying with N1QL] and xref:2.4@nodejs-sdk::n1ql-queries-with-sdk.adoc[N1QL from the SDK].
