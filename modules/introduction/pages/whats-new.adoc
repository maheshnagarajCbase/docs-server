...
Refer to the xref:elasticsearch-transport::index.adoc[documentation] or follow installation and https://github.com/couchbaselabs/elasticsearch-transport-couchbase/blob/master/README.md[configuration walkthrough^].
