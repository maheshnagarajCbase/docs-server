...
Refer to the xref:connectors:elasticsearch/overview.adoc[documentation] or follow installation and https://github.com/couchbaselabs/elasticsearch-transport-couchbase/blob/master/README.md[configuration walkthrough^].
