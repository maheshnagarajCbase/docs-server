...
For details, see xref:n1ql:n1ql-language-reference/from.adoc[FROM] statement syntax and xref:n1ql:n1ql-language-reference/subqueries.adoc#topic_9[Subqueries].
