...
| xref:architecture:storage-architecture.adoc#concept_x13_xlj_vs[ForestDB] iterator returned [.out]`FDB_RESULT_ITERATOR_FAIL` error upon document deletion causing incorrect items in a list to be returned.
