...
You can also change bucket settings using the CLI command xref:cli:cbcli/bucket-edit.adoc[bucket-edit] or the xref:rest-api:rest-bucket-parameters.adoc#rest-bucket-change[bucket REST api].
