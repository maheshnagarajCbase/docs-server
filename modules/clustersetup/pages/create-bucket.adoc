...
You can also set the conflict resolution method using the CLI xref:cli:cbcli/bucket-create.adoc[[.cmd]`bucket-create`] command, or the xref:rest-api:rest-bucket-create.adoc#rest-bucket-create[REST API].

[#image_ady_hfw_py]
image::admin/picts/bucket-create-conflict-resolution-setting.png[,570]
