...
In the cloud:: To enforce security in the Couchbase cloud, you must securely configure the xref:security-acls-new.adoc[Network Access Control Lists (ACLs) and security groups] as well as xref:xdcr:xdcr-intro.adoc#topic1500[Cross Datacenter Replication (XDCR)].
