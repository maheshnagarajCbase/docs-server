...
The xref:tools:query-workbench.adoc#topic_prr_nyh_t5[Query Workbench] is integrated with the Couchbase Web console and is available on the [.ui]*Query* tab.
