...
Once the consumer catches up to the current state of the bucket, try xref:2.4@nodejs-sdk:common:webui-cli-access.adoc[adding a new document to the bucket via the Couchbase Web Console].
